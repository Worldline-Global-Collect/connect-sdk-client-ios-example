...
@interface WCDatePickerTableViewCell ()
@property (nonatomic, strong) UIDatePicker *datePicker;
@end
@implementation WCDatePickerTableViewCell
...
- (void)layoutSubviews {
    ...
    if (self.datePicker != nil) {
        ...
        CGRect frame = CGRectMake(10, 0, width - 20, [WCDatePickerTableViewCell pickerHeight]);
