...
@interface WCCurrencyTableViewCell ()

@property (strong, nonatomic) UILabel *separatorlabel;
@property (strong, nonatomic) UILabel *currencyCodeLabel;
@property (strong, nonatomic) WCIntegerTextField *integerTextField;
@property (strong, nonatomic) WCFractionalTextField *fractionalTextField;

@end

@implementation WCCurrencyTableViewCell
