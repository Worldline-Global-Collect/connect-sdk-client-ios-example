...
@interface WCLabelTableViewCell ()

@property (strong, nonatomic) WCLabel *labelView;

@end

@implementation WCLabelTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        self.labelView = [[WCLabel alloc]init];
